...
if (isset($_POST['agregar'])) {
    ...
    move_uploaded_file($tmp, "../img/productos/" . $imagen);
...
<button class="btn btn-success" name="agregar">Agregar Producto</button>
...
<td>
<img src="../img/productos/<?php echo $p['imagen']; ?>" width="60">
</td>
...
<a href="productos.php?agregar=<?php echo $fila['id_producto']; ?>" class="btn btn-success">
    Agregar al carrito
</a>
<a href="../cliente/agregar_favorito.php?id=<?php echo $producto['id_producto']; ?>"
